...
description: The freedom of hand written notes combined with the power of digital organization.
featured: true
category: portfolio
color: "#583C87"
image:
  url:        
  bg_url:
  hero:     /images/projects/relink/ui-shot-lg.png
categories:
- blog
- web-development
overview: |
  How can the learning experience be improved in higher education? To answer this question, we worked directly with an industry sponsor, Karl Bakeman. As the Editorial Director for Digital Media at [W. W. Norton](http://books.wwnorton.com/books/index.aspx), an independent publishing cooperative based out of New York, Karl was an invaluable resource in understanding trends and expected future of the educational publishing industry.
...
![Storyboard](../../../images/projects/relink/storyboard.jpg)
...
![Scenarios](../../../images/projects/relink/scenarios.jpg)
...
Feedback was identified as a crucial aspect of the design. In addition to providing feedback via a nearby device, we opted to include an LED on the tip of the pen to reinsure the user that their notes and actions were being recorded.
 ...
 ![Scenarios](../../../images/projects/relink/pen-sketch.jpg)
...
![Gestures](../../../images/projects/relink/gestures.jpg)
